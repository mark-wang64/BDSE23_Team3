# -*- coding: utf-8 -*-
"""
Created on Fri Mar 25 01:11:38 2022
...
top5 = ["hotel","room","rooms","hotels","stay","are","were","was","has","have"]


#df = pd.read_parquet(r'C:\Shared\example_parquet2',engine="fastparquet")

df = pd.read_parquet(r'C:\Users\Student\Desktop\Final\Nationality_parquet',engine="fastparquet")
df.iloc[1,[4,5]]
df.iloc[2,5]
df["wordCount"].head()
df_eu = df[df["Region"] == "Europe"]
df_as = df[df["Region"] == "Asia"]
df_am = df[df["Region"] == "America"]
...
result2.to_csv(r'C:\Users\Student\Desktop\oc.csv',index = False)
